    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbar">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item"><a class="nav-link" href="#main">La conferencia</a></li>
          <li class="nav-item"><a class="nav-link" href="#speakers">Las oradores</a></li>
          <li class="nav-item"><a class="nav-link" href="#place-time">El lugar y la fecha</a></li>
          <li class="nav-item"><a class="nav-link" href="registro.html">Registrarse</a></li>
          <li class="nav-item"><a class="nav-link text-codo" href="#" data-toggle="modal" data-target="#modalCompra">Comprar tickets</a></li>
        </ul>
      </div>
    </div>
  </nav>
        ...
        <div class="col col-md-10 offset-md-1 col-lg-8 offset-lg-2 pt-2">
          <form action="insertar.php" method="post"> 
            ...
            <div class="form-row">
              ...
              <div class="col">
                <button type="submit" id="botonCalcular"
                  class="btn btn-codo btn-block">Registrarse</button>
              </div>
            </div>
          </form>
